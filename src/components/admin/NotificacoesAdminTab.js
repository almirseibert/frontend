...
const EVENT_TYPES = [
    ...
    { id: 'funcionario_cadastrado',      label: 'Novo funcionário cadastrado',          desc: 'Ao registrar um novo funcionário no sistema.' },
    { id: 'funcionario_reativado',       label: 'Funcionário reativado (readmissão)',   desc: 'Ao reativar um funcionário desligado.' },
    { id: 'funcionario_desligado',       label: 'Funcionário desligado',                desc: 'Ao registrar o desligamento de um funcionário.' },
